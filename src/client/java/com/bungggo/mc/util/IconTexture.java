...
public class IconTexture {
    ...
    public static final Identifier PLAINS_TEXTURE  = Identifier.of("mc-location", "textures/indicator/plains.png");
    public static final Identifier RIVER_TEXTURE = Identifier.of("mc-location", "textures/indicator/river.png");
