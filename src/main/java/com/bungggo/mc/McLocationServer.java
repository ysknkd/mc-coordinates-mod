    ...
    private void registerNetworking() {
        ServerPlayNetworking.registerGlobalReceiver(LocationPayload.ID, (payload, context) -> {
            ...
            context.server().execute(() -> {
                ...
                LocationPayload outgoing = new LocationPayload(senderPlayer.getUuid(), payload.uuid(), payload.x(), payload.y(), payload.z(), payload.description(), payload.world(), payload.pinned(), payload.icon());
